...
<li>
  <a class="Desktop-nav__item active" href="/docs/v0.0.27/defining-routes/">
    Defining routes
  </a>
</li>
  ...
  <div class="Docs-page">
    <div class='Docs-page__header'>
      <div class="Docs-page__version">
        <a class='Docs-page__improve' href="https://github.com/samselikoff/ember-cli-mirage/edit/gh-pages/docs/v0.0.27/defining-routes.md">
          <small>
...
<p>Now, Mirage will respond to this route with all the <code class="highlighter-rouge">user</code> records in its database. To seed your database with data, you’ll use <a href="">fixtures</a> (in development) or <a href="">factories</a> (in testing).</p>
...
<p>Mirage uses Pretender.js to intercept HTTP requests, so check out <a href="">its docs</a> to see the full API for the request object.</p>

<h2 id="using-shorthands">Using shorthands</h2>

<p>JSON APIs have become more standardized, so Mirage has the concept of <em>shorthands</em> to deal with common API scenarios. These shorthands can replace many of your custom route handlers, dramatically simplifying your server definition.</p>
...
<div class="language-js highlighter-rouge"><pre class="highlight"><code><span class="k">this</span><span class="p">.</span><span class="nx">post</span><span class="p">(</span><span class="s1">'/api/users'</span><span class="p">);</span>
</code></pre>
</div>

<p>View the <a href="../shorthands">shorthand reference</a> to see all available shorthands.</p>
...
<ul>
  <li><code class="highlighter-rouge">get</code> is 200</li>
  <li><code class="highlighter-rouge">put</code> is 204</li>
  <li><code class="highlighter-rouge">post</code> is 201</li>
  <li><code class="highlighter-rouge">del</code> is 204</li>
</ul>

<p>Additionally, a header for <code class="highlighter-rouge">Content-type</code> is set to <code class="highlighter-rouge">application/json</code>. You can customize both the response code and headers by returning an instance of <code class="highlighter-rouge">Mirage.Response</code>:</p>

<div class="language-js highlighter-rouge"><pre class="highlight"><code><span class="k">this</span><span class="p">.</span><span class="nx">post</span><span class="p">(</span><span class="s1">'/api/users'</span><span class="p">,</span> <span class="kd">function</span><span class="p">(</span><span class="nx">db</span><span class="p">,</span> <span class="nx">request</span><span class="p">)</span> <span class="p">{</span>
  <span class="kd">var</span> <span class="nx">data</span> <span class="o">=</span> <span class="nx">JSON</span><span class="p">.</span><span class="nx">parse</span><span class="p">(</span><span class="nx">request</span><span class="p">.</span><span class="nx">requestBody</span><span class="p">);</span>
...
<p>That’s the essentials of defining your routes. Next, you’ll learn how to seed your database with some starting data, both in development and testing.</p>
...
<div class='Docs-page-nav'>
         ...
         <a class="Docs-page-nav__link u-first" href="/docs/v0.0.27/quickstart/">< Quickstart</a>
         ...
         <a class="Docs-page-nav__link u-last" href="/docs/v0.0.27/seeding-your-database/">Seeding your database ></a>
