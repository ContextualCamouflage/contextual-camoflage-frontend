...
<li>
  <a class="Desktop-nav__item active" href="/docs/v0.0.27/">
    Overview
  </a>
</li>
  ...
  <div class="Docs-page">
    <div class='Docs-page__header'>
      <div class="Docs-page__version">
        <a class='Docs-page__improve' href="https://github.com/samselikoff/ember-cli-mirage/edit/gh-pages/docs/v0.0.27/index.md">
          <small>
    ...
    <div class='Docs-page__content'>
      <p>Nearly all Ember apps interact with a JSON API. When you reach the point during development when you need to interact with dynamic server data, you have a few options:</p>
...
<div class='Docs-page-nav'>
         ...
         <a class="Docs-page-nav__link u-last" href="/docs/v0.0.27/installation/">Installation ></a>
