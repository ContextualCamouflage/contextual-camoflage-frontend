...
<li>
  <a class="Desktop-nav__item active" href="/docs/v0.0.27/installation/">
    Installation
  </a>
</li>
  ...
  <div class="Docs-page">
    <div class='Docs-page__header'>
      <div class="Docs-page__version">
        <a class='Docs-page__improve' href="https://github.com/samselikoff/ember-cli-mirage/edit/gh-pages/docs/v0.0.27/installation.md">
          <small>
...
<p>Be sure to add <code class="highlighter-rouge">server</code> to your <code class="highlighter-rouge">/tests/.jshint</code> file under the <code class="highlighter-rouge">predef</code> section.</p>
...
<div class='Docs-page-nav'>
         ...
         <a class="Docs-page-nav__link u-first" href="/docs/v0.0.27/">< Overview</a>
         ...
         <a class="Docs-page-nav__link u-last" href="/docs/v0.0.27/quickstart/">Quickstart ></a>
