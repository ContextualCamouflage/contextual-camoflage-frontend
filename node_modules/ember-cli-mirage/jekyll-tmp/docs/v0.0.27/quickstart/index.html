...
<li>
  <a class="Desktop-nav__item active" href="/docs/v0.0.27/quickstart/">
    Quickstart
  </a>
</li>
  ...
  <div class="Docs-page">
    <div class='Docs-page__header'>
      <div class="Docs-page__version">
        <a class='Docs-page__improve' href="https://github.com/samselikoff/ember-cli-mirage/edit/gh-pages/docs/v0.0.27/quickstart.md">
          <small>
...
<p>Now, if we want to change what data this route responds with, all we need to do is change the data in the database. There’s a few ways to do this.</p>

<aside class="Docs-page__aside">
  <p>Learn more about <a href="../seeding-your-database">fixtures</a>.</p>
</aside>

<p>In development, you add data to your database by creating files under the <code class="highlighter-rouge">/mirage/fixtures</code> directory. These files should export arrays of objects, like this:</p>
...
<p>These objects will be added to the <code class="highlighter-rouge">users</code> database table, since the filename is <code class="highlighter-rouge">users.js</code>. Now, any route can retrieve this data via <code class="highlighter-rouge">db.users</code>, and we have a single place to manage our mock data.</p>

<aside class="Docs-page__aside">
  <p>Learn more about <a href="../seeding-your-database">factories</a>.</p>
</aside>

<p>In acceptance testing, you use factories to create database data. Factories give you finer control over what data you create, which is useful for setting up initial state in your tests.</p>
...
<p>Each time you create an object from this factory, it will insert a record into your <code class="highlighter-rouge">users</code> table, giving that record an id and a name of <code class="highlighter-rouge">Person 1</code>, <code class="highlighter-rouge">Person 2</code>, and so on.</p>

<p>To use your factories, use <code class="highlighter-rouge">server.create</code> or <code class="highlighter-rouge">server.createList</code> in a test:</p>
...
<p>Creating a resource using the request payload is just as easy:</p>
...
<div class='Docs-page-nav'>
         ...
         <a class="Docs-page-nav__link u-first" href="/docs/v0.0.27/installation/">< Installation</a>
         ...
         <a class="Docs-page-nav__link u-last" href="/docs/v0.0.27/defining-routes/">Defining routes ></a>
