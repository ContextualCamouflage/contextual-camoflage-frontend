...
<li>
  <a class="Desktop-nav__item active" href="/docs/v0.0.27/server-configuration/">
  ...
  <div class="Docs-page">
    <div class='Docs-page__header'>
      <div class="Docs-page__version">
        <a class='Docs-page__improve' href="https://github.com/samselikoff/ember-cli-mirage/edit/gh-pages/docs/v0.0.27/server-configuration.md">
          <small>
...
<p>Set the base namespace used for all routes defined with <code class="highlighter-rouge">get</code>, <code class="highlighter-rouge">post</code>, <code class="highlighter-rouge">put</code> or <code class="highlighter-rouge">del</code>. For example,</p>
...
<div class='Docs-page-nav'>
         ...
         <a class="Docs-page-nav__link u-first" href="/docs/v0.0.27/acceptance-testing/">< Acceptance testing</a>
         ...
         <a class="Docs-page-nav__link u-last" href="/docs/v0.0.27/routes/">Routes ></a>
