...
<li>
  <a class="Desktop-nav__item active" href="/docs/v0.1.x/acceptance-testing/">
    Acceptance testing
  </a>
</li>
  ...
  <div class="Docs-page">
    <div class='Docs-page__header'>
      <div class="Docs-page__version">
        <a class='Docs-page__improve' href="https://github.com/samselikoff/ember-cli-mirage/edit/gh-pages/docs/v0.1.x/acceptance-testing.md">
          <small>
...
<p>Many of these tests rely on a given server state. In other words, you want to test that the user can view ten photos, <em>given ten photo resources exist on the server</em> when the user boots the app. This is where factories come in.</p>

<p>Factories let you define the initial server state directly in your tests:</p>
...
<h2 id="fixtures-in-acceptance-tests">Fixtures in acceptance tests</h2>

<p>Mirage recommends that you use factories in testing, as they make your tests more intention-revealing. If you’d like to load your fixture files during testing, use the <code class="highlighter-rouge">loadFixtures</code> API. To have all fixtures loaded for each test, and to not use factories at all, simply delete your <code class="highlighter-rouge">/mirage/factories</code> directory.</p>

<h2 id="asserting-a-server-call-was-made-in-a-test">Asserting a server call was made in a test</h2>
<p>Typically you’ll write tests against your application’s UI, which will verify that the proper data from Mirage was returned. It also is nice to verify the data made it to the server, to give you more confidence your Ember app is making the XHR requests you expect it should be.</p>

<p>You can easily assert against Mirage’s database state in your tests</p>

<div class="language-js highlighter-rouge"><pre class="highlight"><code><span class="nx">test</span><span class="p">(</span><span class="s1">'I can update the contact'</span><span class="p">,</span> <span class="kd">function</span><span class="p">(</span><span class="nx">assert</span><span class="p">)</span> <span class="p">{</span>
  <span class="nx">server</span><span class="p">.</span><span class="nx">create</span><span class="p">(</span><span class="s1">'contact'</span><span class="p">,</span> <span class="p">{</span> <span class="na">name</span><span class="p">:</span> <span class="s1">'Lnk'</span> <span class="p">});</span>

  <span class="nx">visit</span><span class="p">(</span><span class="s1">'/contacts/1'</span><span class="p">);</span>
  <span class="nx">click</span><span class="p">(</span><span class="s1">'.edit'</span><span class="p">);</span>
  <span class="nx">fillIn</span><span class="p">(</span><span class="s1">'input.name'</span><span class="p">,</span> <span class="s1">'Link'</span><span class="p">)</span>
  ...
  <span class="nx">andThen</span><span class="p">(()</span> <span class="o">=&gt;</span> <span class="p">{</span>
    <span class="nx">assert</span><span class="p">.</span><span class="nx">equal</span><span class="p">(</span><span class="nx">server</span><span class="p">.</span><span class="nx">db</span><span class="p">.</span><span class="nx">contacts</span><span class="p">[</span><span class="mi">0</span><span class="p">].</span><span class="nx">name</span><span class="p">,</span> <span class="s1">'Link'</span><span class="p">);</span>
  <span class="p">});</span>
<span class="p">});</span>
</code></pre>
</div>

<p>Some people prefer to assert against the actual request body, which is also possible if you overwrite the relevant route handler in your test:</p>
...
<div class="language-js highlighter-rouge"><pre class="highlight"><code><span class="nx">test</span><span class="p">(</span><span class="s1">'I can update the contact'</span><span class="p">,</span> <span class="kd">function</span><span class="p">(</span><span class="nx">assert</span><span class="p">)</span> <span class="p">{</span>
  ...
  <span class="nx">server</span><span class="p">.</span><span class="nx">put</span><span class="p">(</span><span class="s1">'/contacts'</span><span class="p">,</span> <span class="p">(</span><span class="nx">db</span><span class="p">,</span> <span class="nx">request</span><span class="p">)</span> <span class="o">=&gt;</span> <span class="p">{</span>
    <span class="kd">let</span> <span class="nx">params</span> <span class="o">=</span> <span class="nx">JSON</span><span class="p">.</span><span class="nx">parse</span><span class="p">(</span><span class="nx">request</span><span class="p">.</span><span class="nx">requestBody</span><span class="p">).</span><span class="nx">contact</span><span class="p">;</span>
...
<p>Note that this route handler is only in effect for this test.</p>

<p>Either approach you take, you’ll have more confidence that your Ember app’s data calls are making it to your server as expected.</p>

<hr />

<p>You should now know enough to mock out your API and test your app using Mirage!</p>
...
<div class='Docs-page-nav'>
         ...
         <a class="Docs-page-nav__link u-first" href="/docs/v0.1.x/seeding-your-database/">< Seeding your database</a>
         ...
         <a class="Docs-page-nav__link u-last" href="/docs/v0.1.x/working-with-json-api/">Working with JSON:API ></a>
