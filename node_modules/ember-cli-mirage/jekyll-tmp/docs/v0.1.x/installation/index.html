...
<li>
  <a class="Desktop-nav__item active" href="/docs/v0.1.x/installation/">
    Installation
  </a>
</li>
  ...
  <div class="Docs-page">
    <div class='Docs-page__header'>
      <div class="Docs-page__version">
        <a class='Docs-page__improve' href="https://github.com/samselikoff/ember-cli-mirage/edit/gh-pages/docs/v0.1.x/installation.md">
          <small>
...
<div class="highlighter-rouge"><pre class="highlight"><code>ember install:addon ember-cli-mirage
</code></pre>
</div>

<h2 id="bower">Bower</h2>

<p>If something seems wrong after you’ve installed Mirage, try running</p>

<div class="highlighter-rouge"><pre class="highlight"><code>ember generate ember-cli-mirage
</code></pre>
</div>

<p>This ensures all of Mirage’s Bower dependencies are added to your project. It’s supposed to run during <code class="highlighter-rouge">ember install</code>, but this functionality is broken in some versions of Ember CLI.</p>

<h2 id="other-notes">Other notes</h2>

<p>If you are using a version of PhantomJS before 2.0, ensure you have <a href="https://github.com/pixelhandler/ember-cli-es5-shim">ember-cli-es5-shim</a> installed in your app because Mirage uses <code class="highlighter-rouge">.bind</code>.</p>
...
<div class='Docs-page-nav'>
         ...
         <a class="Docs-page-nav__link u-first" href="/docs/v0.1.x/">< Overview</a>
         ...
         <a class="Docs-page-nav__link u-last" href="/docs/v0.1.x/quickstart/">Quickstart ></a>
