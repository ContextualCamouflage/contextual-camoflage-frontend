...
<li>
  <a class="Desktop-nav__item active" href="/docs/v0.1.x/manually-starting-mirage/">
  ...
  <div class="Docs-page">
    <div class='Docs-page__header'>
      <div class="Docs-page__version">
        <a class='Docs-page__improve' href="https://github.com/samselikoff/ember-cli-mirage/edit/gh-pages/docs/v0.1.x/manually-starting-mirage.md">
          <small>
...
<p>Eventually we’ll extract Mirage’s initializer, but for now you can use this workaround. To run your Mirage server during a unit or integration test, first create a helper:</p>

<div class="language-js highlighter-rouge"><pre class="highlight"><code><span class="c1">// tests/helpers/setup-mirage-for-integration.js</span>
<span class="kr">import</span> <span class="nx">mirageInitializer</span> <span class="nx">from</span> <span class="s1">'../../initializers/ember-cli-mirage'</span><span class="p">;</span>

<span class="kr">export</span> <span class="k">default</span> <span class="kd">function</span> <span class="nx">startMirage</span><span class="p">(</span><span class="nx">container</span><span class="p">)</span> <span class="p">{</span>
  <span class="nx">mirageInitializer</span><span class="p">.</span><span class="nx">initialize</span><span class="p">(</span><span class="nx">container</span><span class="p">);</span>
<span class="p">}</span>
</code></pre>
</div>

<p>Then, add the following to any test where you want Mirage to initialize. Note that you should manually shutdown the Mirage server as well:</p>
...
<span class="kr">import</span> <span class="nx">startMirage</span> <span class="nx">from</span> <span class="s1">'../../helpers/setup-mirage-for-integration'</span><span class="p">;</span>
...
<span class="nx">moduleForComponent</span><span class="p">(</span><span class="s1">'your-component'</span><span class="p">,</span> <span class="s1">'Integration | Component | your component'</span><span class="p">,</span> <span class="p">{</span>
  ...
  <span class="nx">beforeEach</span><span class="p">()</span> <span class="p">{</span>
    <span class="nx">startMirage</span><span class="p">(</span><span class="k">this</span><span class="p">.</span><span class="nx">container</span><span class="p">);</span>
  <span class="p">},</span>
  <span class="nx">afterEach</span><span class="p">()</span> <span class="p">{</span>
    <span class="nb">window</span><span class="p">.</span><span class="nx">server</span><span class="p">.</span><span class="nx">shutdown</span><span class="p">();</span>
  <span class="p">}</span>
<span class="p">});</span>
</code></pre>
</div>
...
<div class='Docs-page-nav'>
         ...
         <a class="Docs-page-nav__link u-first" href="/docs/v0.1.x/working-with-json-api/">< Working with JSON:API</a>
         ...
         <a class="Docs-page-nav__link u-last" href="/docs/v0.1.x/simulating-cookie-responses/">Simulating cookie responses ></a>
