...
<li>
  <a class="Desktop-nav__item active" href="/docs/v0.1.x/seeding-your-database/">
  ...
  <div class="Docs-page">
    <div class='Docs-page__header'>
      <div class="Docs-page__version">
        <a class='Docs-page__improve' href="https://github.com/samselikoff/ember-cli-mirage/edit/gh-pages/docs/v0.1.x/seeding-your-database.md">
          <small>
...
<p>If you’ve never used factories before, think of them as a way to make database records. You define factories by creating files under the <code class="highlighter-rouge">/mirage/factories</code> directory. The name of the factory, which you reference in your tests, is determined by the filename.</p>

<p>Factories have attributes which can be strings, numbers, booleans or functions:</p>
...
<p>Mirage also includes the Faker.js library, which pairs nicely with your factories to make your mock data more realistic:</p>
...
<span class="kr">export</span> <span class="k">default</span> <span class="nx">Mirage</span><span class="p">.</span><span class="nx">Factory</span><span class="p">.</span><span class="nx">extend</span><span class="p">({</span>
  <span class="nx">firstName</span><span class="p">()</span> <span class="p">{</span> <span class="k">return</span> <span class="nx">faker</span><span class="p">.</span><span class="nx">name</span><span class="p">.</span><span class="nx">firstName</span><span class="p">();</span> <span class="p">},</span>
  <span class="nx">lastName</span><span class="p">()</span> <span class="p">{</span> <span class="k">return</span> <span class="nx">faker</span><span class="p">.</span><span class="nx">name</span><span class="p">.</span><span class="nx">lastName</span><span class="p">();</span> <span class="p">},</span>
  <span class="nx">age</span><span class="p">()</span> <span class="p">{</span> <span class="k">return</span> <span class="nx">faker</span><span class="p">.</span><span class="nx">list</span><span class="p">.</span><span class="nx">random</span><span class="p">(</span><span class="mi">18</span><span class="p">,</span> <span class="mi">20</span><span class="p">,</span> <span class="mi">28</span><span class="p">,</span> <span class="mi">32</span><span class="p">,</span> <span class="mi">45</span><span class="p">,</span> <span class="mi">60</span><span class="p">);</span> <span class="p">},</span> <span class="c1">// .list method added by Mirage</span>
<span class="p">});</span>
</code></pre>
</div>
...
<p>To seed your database in development, create the file <code class="highlighter-rouge">/app/mirage/scenarios/default.js</code>, and export a function that takes a single argument, <code class="highlighter-rouge">server</code>, your Mirage server’s instance. This function will run when Mirage is initialized during development.</p>

<p>A simple scenario may look like this:</p>
...
<span class="kr">export</span> <span class="k">default</span> <span class="kd">function</span><span class="p">(</span><span class="nx">server</span><span class="p">)</span> <span class="p">{</span>
  <span class="nx">server</span><span class="p">.</span><span class="nx">createList</span><span class="p">(</span><span class="s1">'post'</span><span class="p">,</span> <span class="mi">10</span><span class="p">);</span>

  <span class="kd">var</span> <span class="nx">user</span> <span class="o">=</span> <span class="nx">server</span><span class="p">.</span><span class="nx">create</span><span class="p">(</span><span class="s1">'user'</span><span class="p">,</span> <span class="p">{</span> <span class="na">name</span><span class="p">:</span> <span class="s1">'Zelda'</span> <span class="p">});</span>
  <span class="nx">server</span><span class="p">.</span><span class="nx">createList</span><span class="p">(</span><span class="s1">'comment'</span><span class="p">,</span> <span class="mi">20</span><span class="p">,</span> <span class="p">{</span> <span class="na">user_id</span><span class="p">:</span> <span class="nx">user</span><span class="p">.</span><span class="nx">id</span> <span class="p">});</span>
<span class="p">}</span>
</code></pre>
</div>

<p>Currently, only the default scenario is supported, though there are plans to support switching between multiple scenarios in development.</p>
...
<p>During acceptance testing, Mirage’s initializer is run when your Ember app starts up, and <code class="highlighter-rouge">server</code> is available in each test.</p>

<p>Mirage starts each test with a clean database. Use <code class="highlighter-rouge">create</code> and <code class="highlighter-rouge">createList</code> to define your data on a per-test basis:</p>

<div class="language-js highlighter-rouge"><pre class="highlight"><code><span class="nx">test</span><span class="p">(</span><span class="s1">'I can view the users'</span><span class="p">,</span> <span class="kd">function</span><span class="p">()</span> <span class="p">{</span>
...
<h2 id="using-fixtures-in-your-factory-scenarios-and-tests">Using fixtures in your factory scenarios and tests</h2>

<aside class="Docs-page__aside">
  <p>The <em>loadFixtures</em> feature was added in 0.1.9.</p>
</aside>

<p>You can also use <code class="highlighter-rouge">server.loadFixtures</code> to load fixture files in your default scenario or tests, meaning you can simultaneously leverage fixtures and factories. <a href="../server-configuration/#loadFixtures">See the guide</a> for more info.</p>

<h2 id="relationships-with-factories">Relationships with factories</h2>

<p>You can also create related data with factories. Until <a href="https://github.com/samselikoff/ember-cli-mirage/pull/82">this PR</a> lands, you’ll need to manage the foreign keys yourself, which you’ll do by overriding your factories’ default attributes. Here’s an example:</p>

<div class="language-js highlighter-rouge"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">user</span> <span class="o">=</span> <span class="nx">server</span><span class="p">.</span><span class="nx">create</span><span class="p">(</span><span class="s1">'user'</span><span class="p">);</span>
<span class="nx">server</span><span class="p">.</span><span class="nx">createList</span><span class="p">(</span><span class="s1">'post'</span><span class="p">,</span> <span class="mi">10</span><span class="p">,</span> <span class="p">{</span> <span class="na">user_id</span><span class="p">:</span> <span class="nx">user</span><span class="p">.</span><span class="nx">id</span> <span class="p">});</span>
</code></pre>
</div>

<p>Notice that <code class="highlighter-rouge">create</code> and <code class="highlighter-rouge">createList</code> return the database records that were created by the factory, so you can use the user’s <code class="highlighter-rouge">id</code> to relate the posts back to that user. Now that the foreign keys are set up, you can use the shorthand routes to sideload the user’s related data:</p>

<div class="language-js highlighter-rouge"><pre class="highlight"><code><span class="k">this</span><span class="p">.</span><span class="nx">get</span><span class="p">(</span><span class="s1">'/users/:id'</span><span class="p">,</span> <span class="p">[</span><span class="s1">'user'</span><span class="p">,</span> <span class="s1">'posts'</span><span class="p">]);</span>
</code></pre>
</div>

<p>or interact with the data directly via <code class="highlighter-rouge">db.posts.where({ user_id: user.id })</code>, for example.</p>

<hr />

<h2 id="fixtures">Fixtures</h2>

<p>You can also choose to use fixtures instead of (or in addition to) factories. If you’ve never used fixtures before, think of a fixture file as a database table. To add data to your <code class="highlighter-rouge">users</code> table, for instance, create the file <code class="highlighter-rouge">/app/mirage/fixtures/users.js</code>:</p>
...
<p>Fixture filenames are always plural, and export arrays of POJOs. During development, this data will be added to Mirage’s database and will be available in route handlers via <code class="highlighter-rouge">db.users</code>. Be sure to delete the <code class="highlighter-rouge">/mirage/scenarios</code> directory in order for your fixtures to load during development.</p>

<p>Some people use fixtures during development but choose to use factories in their tests. If you want your fixture files to also load during testing, simply delete the <code class="highlighter-rouge">/mirage/factories</code> directory.</p>
...
<p>Now you can use the shorthand <code class="highlighter-rouge">this.get('/users/:id', ['user', 'addresses']</code>, and Mirage will return the user whose id matches the <code class="highlighter-rouge">:id</code> route param, along with this user’s related addresses - i.e., addresses whose <code class="highlighter-rouge">user_id</code> matches the param.</p>
...
<div class='Docs-page-nav'>
         ...
         <a class="Docs-page-nav__link u-first" href="/docs/v0.1.x/defining-routes/">< Defining routes</a>
         ...
         <a class="Docs-page-nav__link u-last" href="/docs/v0.1.x/acceptance-testing/">Acceptance testing ></a>
