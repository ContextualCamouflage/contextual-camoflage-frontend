...
<li>
  <a class="Desktop-nav__item active" href="/docs/v0.1.x/simulating-cookie-responses/">
  ...
  <div class="Docs-page">
    <div class='Docs-page__header'>
      <div class="Docs-page__version">
        <a class='Docs-page__improve' href="https://github.com/samselikoff/ember-cli-mirage/edit/gh-pages/docs/v0.1.x/simulating-cookie-responses.md">
          <small>
...
<div class="language-javascript highlighter-rouge"><pre class="highlight"><code><span class="k">this</span><span class="p">.</span><span class="nx">post</span><span class="p">(</span><span class="s1">'/users/login'</span><span class="p">,</span> <span class="kd">function</span><span class="p">(</span><span class="nx">db</span><span class="p">,</span> <span class="nx">request</span><span class="p">)</span> <span class="p">{</span>
    ...
    <span class="nb">document</span><span class="p">.</span><span class="nx">cookie</span><span class="o">=</span><span class="err">`</span><span class="nx">remember_me</span><span class="o">=</span><span class="nx">cookie</span><span class="o">-</span><span class="nx">content</span><span class="o">-</span><span class="nx">here</span><span class="p">;</span> <span class="nx">domain</span><span class="o">=</span><span class="p">.</span><span class="nx">dev</span><span class="o">-</span><span class="nx">domain</span><span class="p">;</span> <span class="nx">path</span><span class="o">=</span><span class="sr">/; expires=${cookieExpiration.toUTCString</span><span class="se">()</span><span class="sr">};`</span><span class="err">;
      ...
      <span class="na">users</span><span class="p">:</span> <span class="p">[</span><span class="nx">db</span><span class="p">.</span><span class="nx">users</span><span class="p">[</span><span class="mi">0</span><span class="p">]]</span>
    <span class="p">};</span>
  <span class="p">});</span>
</code></pre>
</div>
...
<div class='Docs-page-nav'>
         ...
         <a class="Docs-page-nav__link u-first" href="/docs/v0.1.x/manually-starting-mirage/">< Manually starting Mirage</a>
         ...
         <a class="Docs-page-nav__link u-last" href="/docs/v0.1.x/server-configuration/">Server configuration ></a>
