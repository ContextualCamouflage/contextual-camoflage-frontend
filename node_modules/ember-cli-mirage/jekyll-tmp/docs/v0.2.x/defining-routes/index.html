...
<li>
  <a class="Desktop-nav__item active" href="/docs/v0.2.x/defining-routes/">
    Defining routes
  </a>
</li>
  ...
  <div class="Docs-page">
    <div class='Docs-page__header'>
      <div class="Docs-page__version">
        <a class='Docs-page__improve' href="https://github.com/samselikoff/ember-cli-mirage/edit/gh-pages/docs/v0.2.x/defining-routes.md">
          <small>
...
<p><code class="highlighter-rouge">hasMany</code> tells Mirage that it can find this author’s posts using the <code class="highlighter-rouge">authorId</code> field. Now, our route handler for deleting an author looks like this:</p>
...
<div class='Docs-page-nav'>
         ...
         <a class="Docs-page-nav__link u-first" href="/docs/v0.2.x/upgrading/">< Upgrading</a>
         ...
         <a class="Docs-page-nav__link u-last" href="/docs/v0.2.x/seeding-your-database/">Seeding your database ></a>
