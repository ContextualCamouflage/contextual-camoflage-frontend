...
<li>
  <a class="Desktop-nav__item active" href="/docs/v0.2.x/models/">
    Models
  </a>
</li>
  ...
  <div class="Docs-page">
    <div class='Docs-page__header'>
      <div class="Docs-page__version">
        <a class='Docs-page__improve' href="https://github.com/samselikoff/ember-cli-mirage/edit/gh-pages/docs/v0.2.x/models.md">
          <small>
...
<p>Mirage’s ORM should currently be considered somewhat half-finished. The simple case of one-to-many relationships is supported (even chained). However, one-to-one, many-to-many, polymorphic and reflexive relationships are not yet first-class citizens in the ORM/serializer layer. There are a few ways to get around this for now, which all involve you manually solving this in some way:</p>

<ul>
  <li>in some cases <a href="../serializers/#serializeresponse-request">overwriting #serialize</a> will be sufficient to support your use case</li>
  <li>otherwise, it might be easiest to <a href="../route-handlers/#serialize">call this.serialize in your route handler</a>, using the currently supported ORM/serializer layer to get you partially there, then do final data munging to add additional data</li>
</ul>
...
<div class='Docs-page-nav'>
         ...
         <a class="Docs-page-nav__link u-first" href="/docs/v0.2.x/fixtures/">< Fixtures</a>
         ...
         <a class="Docs-page-nav__link u-last" href="/docs/v0.2.x/schema/">Schema ></a>
