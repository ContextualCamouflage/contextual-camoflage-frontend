...
<li>
  <a class="Desktop-nav__item active" href="/docs/v0.3.x/serializers/">
    Serializers
  </a>
</li>
  ...
  <div class="Docs-page">
    <div class='Docs-page__header'>
      <div class="Docs-page__version">
        <a class='Docs-page__improve' href="https://github.com/samselikoff/ember-cli-mirage/edit/gh-pages/docs/v0.3.x/serializers.md">
          <small>
    ...
    <div class='Docs-page__content'>
      <p>Serializers are responsible for formatting your route handler’s response.</p>
...
<span class="kr">export</span> <span class="k">default</span> <span class="nx">ActiveModelSerializer</span><span class="p">;</span>
  ...
  <li>
    <p><strong>RestSerializer</strong>, to fake backends that match Ember Data’s RestSerializer expected response format:</p>
...
<p>Take a look at the included <a href="https://github.com/samselikoff/ember-cli-mirage/blob/master/addon/serializers/active-model-serializer.js#L22">ActiveModelSerializer’s normalize method</a> for an example.</p>
...
<p>Use this property on a model serializer to specify related models you’d like to include in your JSON payload.</p>
...
<p>Used to customize how a model’s attribute is formatted in your JSON payload.</p>
...
<p>For example, if you’re serializing an <code class="highlighter-rouge">author</code> that
...
<div class='Docs-page-nav'>
         ...
         <a class="Docs-page-nav__link u-first" href="/docs/v0.3.x/schema/">< Schema</a>
         ...
         <a class="Docs-page-nav__link u-last" href="/docs/v0.3.x/shorthands/">Shorthands ></a>
